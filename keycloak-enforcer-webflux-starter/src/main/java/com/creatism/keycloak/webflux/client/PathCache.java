...
public class PathCache {
    ...
    public CacheEntry getCacheClone(String uri) {
        if (parkForReadAndCheckInterrupt()) {
            return null;
        }
        ...
        CacheEntry replicas = cached.clone();
        removeIfExpired(cached);
        return replicas;
    }
    ...
    public static final class CacheEntry implements Cloneable {
        ...
        public CacheEntry clone() {
            try {
                ...
                throw new RuntimeException("CacheEntry#"+ this +" is not cloneable");
            }
        }
    }
}
